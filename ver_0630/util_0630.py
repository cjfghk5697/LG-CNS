...
def get_init_bundle_4_order_bundle_maker(K, ALL_RIDERS, ALL_ORDERS, DIST, init_availables, weight1, weight2):
    for rider_i in range(3):
        ALL_RIDERS[rider_i].available_number = init_availables[rider_i]
    ...
    for bundle_num1, bundle_num2, diff_score in edges:
        ...
        new_bundle = try_merging_bundles_by_dist(K, DIST, ALL_ORDERS, ALL_RIDERS, all_bundles[rbn1], all_bundles[rbn2], 2)
        if new_bundle is not None:
            all_bundles[rbn1].rider.available_number += 1
            all_bundles[rbn2].rider.available_number += 1
            new_bundle.rider.available_number -= 1
    ...
    parent = [find(v) for v in parent]
    all_bundles = [all_bundles[v] for v in set(parent)]
    ...
    for bundle_num1, bundle_num2, diff_score in edges:
        ...
        new_bundle = try_merging_bundles_by_dist(K, DIST, ALL_ORDERS, ALL_RIDERS, all_bundles[rbn1], all_bundles[rbn2], 4)
    ...
    all_bundles = new_all_bundles.copy()
    ...
    for bundle_num1, bundle_num2, diff_score in edges:
        ...
        new_bundle = try_merging_bundles_by_dist(K, DIST, ALL_ORDERS, ALL_RIDERS, all_bundles[rbn1], all_bundles[rbn2], 3)
        if new_bundle is not None:
            all_bundles[rbn1].rider.available_number += 1
            all_bundles[rbn2].rider.available_number += 1
            new_bundle.rider.available_number -= 1
...
def try_merging_bundles_by_dist(K, dist_mat, all_orders, all_riders, bundle1, bundle2, order_count_upper_limit=3):
