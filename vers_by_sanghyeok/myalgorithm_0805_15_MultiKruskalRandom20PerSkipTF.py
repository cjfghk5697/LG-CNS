...
def select_weight_opt_method(method_num, K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility):
    if method_num == 1:
        min_init_cost_bundles, result_rider_availables = KruskalRandom20PerSkipTF(K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility)

    return min_init_cost_bundles, result_rider_availables

def KruskalRandom20PerSkipTF(K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility):
    inf = float('inf')
