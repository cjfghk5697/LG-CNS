# https://github.com/cjfghk5697/LG-CNS/blob/han/Han/based%20siwoo/weight%20update%20function%20copy%202/han_SA_myalgorithm.py 개선 시도
...
def algorithm(K, all_orders, all_riders, dist_mat, timelimit=60):
    ...
    for weight_comb_i, (weight1, weight2) in enumerate(weight_grid):
        ...
        if (cur_time - start_time > 40) or (weight_comb_i >= 1 and cur_time + temp_process_time >= 45):
            break
