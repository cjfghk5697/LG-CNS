# https://github.com/cjfghk5697/LG-CNS/blob/han/Han/based%20siwoo/weight%20update%20function%20copy%202/han_SA_myalgorithm.py 번들링 최적화
    ...
    for weight3 in [0, 1, -1, 2, -2]:
        for weight1, weight2 in weight_grid:
            ...
            if cost < min_init_cost:
                ...
                min_weight_comb = (1, weight1, weight2, weight3)
            ...
            if cost < min_init_cost:
                ...
                min_init_cost_bundles = bundles
                min_init_cost_rider_availables = result_rider_availables
                min_weight_comb = (2, weight1, weight2, weight3)
