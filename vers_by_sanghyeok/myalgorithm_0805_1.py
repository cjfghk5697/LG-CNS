...
def kruskal_top_n_iter(K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility):
    inf = float('inf')
    ...
    for weight1, weight2, weight3 in weight_grid:
        ...
        bundles, rider_availables, _ = get_init_bundle(K, ALL_RIDERS, ALL_ORDERS, DIST, init_availables, weight1, weight2, weight3, try_merging_bundles_by_dist_possibles_only, order_comb_possibility, optimized_order_perms, False, 4)
        for rider_i in range(3):
        ...
        if cost < min_init_cost:
            min_init_cost = cost
            min_init_cost_bundles = bundles
            min_init_cost_rider_availables = rider_availables
            min_weight_comb = [weight1, weight2, weight3]
...
def select_weight_opt_method(method_num, K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility):
    if method_num <= 3:
        ...
        min_init_cost_bundles, result_rider_availables = bundling_opt_ver1_KruskalRandom_KCasework(K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility)
         ...
         min_init_cost_bundles, result_rider_availables = kruskal_top_n_iter(K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility)       
...
def algorithm(K, all_orders, all_riders, dist_mat, timelimit=60):
    ...
    #     result = pool.starmap(select_weight_opt_method, [[5, K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility],
    #                                                     [5, K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility],
    #                                                     [5, K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility],
    #                                                     [5, K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility],])
    ...
    min_init_cost_bundles, min_init_cost_rider_availables  = select_weight_opt_method(5, K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility)
