...
def bundling_opt_ver1_5Orders(method_num, K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility):
    ...
    for weight_i, (weight1, weight2, weight3, weight4) in enumerate(weight_grid):
        ...
        if method_num == 1:
            ...
            bundles, result_rider_availables, _ = get_init_bundle(K, ALL_RIDERS, ALL_ORDERS, DIST, init_availables, weight1, weight2, weight3, weight4, try_merging_bundles_by_dist_possibles_only, order_comb_possibility, optimized_order_perms, False, 3)
            bundles, result_rider_availables, _ = get_init_bundle(K, ALL_RIDERS, ALL_ORDERS, DIST, init_availables, weight1, weight2, weight3, weight4, try_merging_bundles_by_dist_possibles_only, order_comb_possibility, optimized_order_perms, False, 5)
...
def bundling_opt_ver1_KruskalRandom_KCasework(K, all_orders, all_riders, dist_mat, timelimit, all_bundles, start_time, car_rider, ALL_ORDERS, ALL_RIDERS, DIST, init_availables, order_comb_possibility):
    ...
    if K >= 200:
        ...
        for _ in range(5):
            weight2 = 0
            for _ in range(7):
                weight_grid.append((weight1, weight2, 0, 1))
                weight2 -= 0.5
            weight1 += 0.5
    else:
        weight1 = 0
    ...
    for weight1, weight2, weight3, weight4 in weight_grid:
        cur_time = time.time()
        ...
        bundles, result_rider_availables, cost = get_init_bundle_4_order_bundle_prefered_with_reassigning_riders(
                K, ALL_RIDERS, ALL_ORDERS, DIST, init_availables, weight1, weight2, weight3, weight4, order_comb_possibility, optimized_order_perms, False)
    ...
    while True:
        ...
        bundles, result_rider_availables, cost = get_init_bundle_4_order_bundle_prefered_with_reassigning_riders(
            K, ALL_RIDERS, ALL_ORDERS, DIST, init_availables, weight1, weight2, weight3, weight4,order_comb_possibility, optimized_order_perms, True)
