# https://github.com/cjfghk5697/LG-CNS/blob/siwoo/0801/han_SA_util.py + 주문쌍 확인 + 주문 조합 한 번씩만 확인하기
    ...
    for rider_i in range(3):
        ...
        if total_volume <= rider.capa:
            ...
            if rider_min_total_dist != inf:
                optimized_order_perms[rider_i][merged_orders_sorted] = Bundle(all_orders, rider, list(rider_min_total_dist_shop_pen), list(rider_min_total_dist_dlv_pen), bundle1.total_volume+bundle2.total_volume, rider_min_total_dist)
            else:
